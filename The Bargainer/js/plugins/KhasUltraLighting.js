...
Khas.Lighting.LIGHTS = {
  guard: {
    fileName: "white",
    intensity: 80, variation: 20, size: 48 * 4,
    offset_x: 0, offset_y: 0
  },
  people: {
    fileName: "white",
    intensity: 75, variation: 0, size: 48 * 2,
    offset_x: 0, offset_y: 0
  },
  cultivate: {
    fileName: "green",
    intensity: 45, variation: 0, size: 48 * 2,
    offset_x: 0, offset_y: 0
  },
  // ARTIFICIAL
  halogen: {
  ...
  teleport: {
    fileName: "flashlight_8",
    intensity: 75, variation: 0, size: 48 * 5,
    offset_x: 0, offset_y: 0
  },
  // CANDLE
  candle: {
  ...
  torch: {
    fileName: "torch",
    intensity: 80, variation: 60, size: 48 * 2,
    offset_x: 4, offset_y: 8
  },
  torch_nick_home: {
    fileName: "torch",
    intensity: 60, variation: 10, size: 48 * 6,
    offset_x: 0, offset_y: 0
  },
  torch_big: {
    fileName: "torch",
    intensity: 80, variation: 75, size: 48 * 4,
    offset_x: 0, offset_y: 0
  },
  white_torch: {
    fileName: "white",
  ...
  red_torch: {
    fileName: "red",
    intensity: 80, variation: 20, size: 48 * 2,
    offset_x: 0, offset_y: 0
  },
  green_torch: {
    fileName: "green",
